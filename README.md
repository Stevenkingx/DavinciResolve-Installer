...
[![Watch the tutorial](docs/video-poster-en.png)](https://github.com/Stevenkingx/DavinciResolve-Installer/releases/download/v1.0.0/DaVinci-Resolve-Manager-tutorial-en.mp4)

**[▶ Watch the tutorial (English, 3:15)](https://github.com/Stevenkingx/DavinciResolve-Installer/releases/download/v1.0.0/DaVinci-Resolve-Manager-tutorial-en.mp4)** — it walks through the error
you are probably hitting, why it happens, and the whole install from dropping
the zip to opening Resolve.
También disponible **[en español (3:44)](https://github.com/Stevenkingx/DavinciResolve-Installer/releases/download/v1.0.0/DaVinci-Resolve-Manager-tutorial-es.mp4)**.
